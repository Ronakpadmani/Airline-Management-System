...
public class EmployeesController {
	...
	public static void EditEmployee(Database database,Scanner s) throws SQLException {
		...
		String update = "UPDATE `employees` SET `id`='"+employee.getId()+"',`firstName`='"+employee.getFirstName()+"',`lastName`='"+employee.getLastName()+"',`Tel`='"+employee.getTel()+"',`email`='"+employee.getEmail()+"',`salary`='"+employee.getSalary()+"',`position`='"+employee.getPosition()+"' WHERE `id` = '"+employee.getId()+"';";
